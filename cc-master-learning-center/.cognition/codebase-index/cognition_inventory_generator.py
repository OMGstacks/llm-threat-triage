...
Deliberately scoped to cc-master-learning-center's own toolkit, not to the
sibling projects at root / osai-prep-studio -- porting this generator (and
the rest of the substrate) to those is Slice 5, out of scope here.
"""
