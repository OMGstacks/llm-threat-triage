...
`../reference/owasp-llm-top-10.md` · `../reference/mitre-atlas.md` · `../reference/owasp-agentic-threats.md` · `../reference/nist-ai-rmf.md` · `../reference/glossary.md` · `../docs/playbook/analyst-runbook.md` · `../docs/llm-log-triage-case-study.pdf` · the studio's own lesson MDX and lab manifests. *These are the highest-precision chunks* — original, tagged, and already mapped to the taxonomy. **Wired into retrieval:** the eight `reference/*.md` files are the tutor's live corpus (`tutor.DEFAULT_SOURCES`); `owasp-agentic-threats.md` (T1–T15), `nist-ai-rmf.md` (RMF functions + the AI 600-1 GenAI risks), `ai-redteam-tooling.md` (PyRIT/garak/promptfoo/Giskard + when-to-use), `osai-studio-architecture.md` (the studio's own components, trust boundaries, and per-lab attack→detector→defense), and `agentic-tool-use-decisions.md` (allow/block/require-approval + injection-vs-benign guidance) were added to ground agentic, NIST, tooling, **architecture_reasoning**, **lab_grounded**, and **tool_use_judgment** items in the gold set.
