...
1. Inspect the primary checkout's current state (branch, divergence) without touching it:
   `git -C C:/Users/izuuh/projects/llm-threat-triage/cc-master-learning-center worktree list`
2. Fetch the default branch fresh (not local disk, which may be stale):
   `git -C C:/Users/izuuh/projects/llm-threat-triage/cc-master-learning-center fetch origin main --quiet`
3. Create an ISOLATED workspace (a worktree, a separate clone, or your project's
   ...
   `git -C C:/Users/izuuh/projects/llm-threat-triage/cc-master-learning-center worktree add -b <descriptive-branch-name> C:/tmp/llm-threat-triage-<task> origin/main`
...
8. Merge: `gh pr merge`. If your project's merge tool cannot also
   ...
   ```
   git -C C:/Users/izuuh/projects/llm-threat-triage/cc-master-learning-center worktree remove --force C:/tmp/llm-threat-triage-<task>
   git -C C:/Users/izuuh/projects/llm-threat-triage/cc-master-learning-center branch -D <descriptive-branch-name>
