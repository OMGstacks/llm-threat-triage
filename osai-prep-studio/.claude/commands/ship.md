...
1. **Scope.** From inside the isolated workspace's `osai-prep-studio/` subdirectory
   (`../llm-threat-triage-wt-<task>/osai-prep-studio`): `git status --porcelain` and
