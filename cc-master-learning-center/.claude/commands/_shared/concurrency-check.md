...
`not applicable on this branch — the sibling cognition-substrate branch (merged to main) built .cognition/active-work/claims_cli.py after this branch diverged; not yet ported here`. Until such a registry exists, the three-step
